...
DELIVERABLES: list[Deliverable] = [
    ...
    Deliverable("M35", "Public landing page: the ecosystem front door", "6",
                "UI-12, UI-04, ADR-0024, ADR-0025, ADR-0026",
                Evidence(symbols=["agrivardhak.api.public:platform_stats"],
                         files=["apps/web/src/app/(public)/layout.tsx",
                                "apps/web/src/components/public-header.tsx",
                                "apps/web/src/components/landing/landing-page.tsx",
                                "apps/web/src/components/landing/hero-carousel.tsx",
                                "apps/web/src/components/landing/stats-band.tsx",
                                "apps/web/src/lib/public-stats.ts",
                                "apps/web/public/hero/hero-01-paddy.jpg",
                                "scripts/build_hero_media.py"],
                         tests=["test_platform_stats_needs_no_token",
                                "test_platform_stats_counts_match_the_database",
                                "test_platform_stats_acres_are_converted_from_square_metres",
                                "test_the_published_totals_match_the_demo_context"])),
