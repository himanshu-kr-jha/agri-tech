...
## MVP progress: 57/58 MUST deliverables (98%)
...
| Fact | Value |
|---|---|
| Test suite | **RED** — 470 passed, 4 failed, 0 xfail placeholders |
| Database tables | 54 |
...
### Phase 6 — Data Observer: the external corpus (docs/adr/0018) — 6/7
...
| 🟡 | M34 | Site-wide Hindi/English page translation over Sarvam | `UI-11, NFR-304, NFR-505, ADR-0023` | missing: test:test_the_hand_written_dictionary_uses_the_glossary |
| ✅ | M35 | Public landing page: the ecosystem front door | `UI-12, UI-04, ADR-0024, ADR-0025, ADR-0026` | 13/13 checks |
...
### Deployment — hosted pilot (docs/adr/0019) — 1/1

| | ID | Deliverable | Requirements | Evidence |
|---|---|---|---|---|
| ✅ | M-DEPLOY | Self-sufficient schema + API image (Supabase/Render/Vercel) | `ADR-0019, NFR-403` | 8/8 checks |
