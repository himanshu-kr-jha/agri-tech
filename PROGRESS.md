...
## MVP progress: 51/51 MUST deliverables (100%)
...
| Fact | Value |
|---|---|
| Test suite | green — 387 passed, 0 failed, 0 xfail placeholders |
| Database tables | 52 |
...
### Deployment — hosted pilot (docs/adr/0018) — 1/1

| | ID | Deliverable | Requirements | Evidence |
|---|---|---|---|---|
| ✅ | M-DEPLOY | Self-sufficient schema + API image (Supabase/Render/Vercel) | `ADR-0018, NFR-403` | 8/8 checks |
